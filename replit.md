...
### Ключевое открытие: Серии чаще ПРОДОЛЖАЮТСЯ!

| Серия | Break Rate | Стратегия |
|-------|-----------|-----------|
| Win 7+ | 28.8% | Ставить на ПРОДОЛЖЕНИЕ |
| Loss 7+ | 50.0% | Ставить на ПРЕРЫВАНИЕ |

### Прибыльные стратегии (на 2619 матчах)

| Стратегия | n | Win Rate | ROI |
|-----------|---|----------|-----|
| Win 7+ → CONTINUE | 66 | 71.2% | **+3.0%** |
| Loss 7+ → BREAK | 28 | 50.0% | **+6.2%** |
| **Комбинированная** | 94 | 64.9% | **+4.0%** |

### Правила ставок
1. **Серия побед 7+** → ставить на ПРОДОЛЖЕНИЕ серии (momentum)
2. **Серия поражений 7+** → ставить на ПРЕРЫВАНИЕ (regression to mean)
3. Коэффициенты андердогов дают лучший ROI при серии поражений
